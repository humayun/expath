...
Fname="Features_PreExp"
setwd("R:/Beck Lab/_USERS/Octavian/Expansion Microscopy/RESULTS/_MAX projection SAMPLES/Analysis_2nd_Submission/PreExpansion/")
...
x.Mean = x[,(Features.Cat == "Mean")]
x.STD = x[,(Features.Cat == "STD")]

x2 = cbind(x.Mean,x.STD)
x2$label = y
write.csv(x2, 'Data_2Summary_4Classes.csv', row.names=FALSE)

case = 'Data_2Summary_4Classes'
