...
%HOMEIMAGES = '/groups/becklab/Expansion/Expanded/';
HOMEIMAGES = 'Expanded/';
...
%% Case 1: All Nuclei
    ...
    im_P = imdilate(boundarymask(BW), ones(5,5));
    ...
    im_P = imdilate(boundarymask(GT), ones(5,5));
    ...
    [OL_IM,OL_RGB] = FuseGTAndBW(GT,BW,im);
...
%% Case 2: Strong Nuclei
    ...
    im_P = imdilate(boundarymask(GT_Nuclei), ones(5,5));
...
%% Case 3; Weak Nuclei
    ...
    OL_RGB_OL = imoverlay_v2(OL_RGB_OL,OL_RGB(:,:,2),'color',[0 1 0],'alpha',0.75,'bright');
    OL_RGB_OL = imoverlay_v2(OL_RGB_OL,OL_RGB(:,:,3),'color',[1 1 0],'alpha',0.75,'bright');
    imwrite(OL_IM,strcat(OverlayPath,ImageName,'_WN_Overlay_BWonGT_TPFPFN.png'));    
