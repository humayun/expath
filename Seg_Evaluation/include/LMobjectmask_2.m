function [mask, class, maskpol, classpol] = LMobjectmask_2(annotation, var, objectlist) 
...
if nargin == 3
    if isfield(annotation, 'object')
        ...
        class = []; mask = [];
        j = strfind(objectlist,','); 
        j = [0 j length(objectlist)+1];
