...
narginchk(1,7);%iptchecknargin(1,7,nargin,mfilename);
warning('off', 'all');  %
% Check I
I = varargin{1};
validateattributes(I,{'logical','numeric'},{'2d','real','nonsparse'}, ...
    mfilename,'I',1); %iptcheckinput
% ------------------------
% Assign Defaults
% -------------------------
...
if nargin ~= 1
    ...
    for k = 2:2:nargin
        ...
        inputStr = validatestring(param, paramStrings, mfilename, 'PARAM', k);% iptcheckstrs
        ...
        switch (inputStr)
            ...
            case 'Offset'
                ...
                iptcheckinput(offset,{'logical','numeric'},...
                    ...
                    mfilename, 'OFFSET', idx); %iptcheckinput %validateattributes
                % must be row vector 
                if size(offset,2) ~= 1
            ...
            case 'NumLevels'
                ...
                iptcheckinput(nl,{'logical','numeric'},...
                    ...
                    mfilename, 'NL', idx); %iptcheckinput %validateattributes
                if numel(nl) > 1
            ...
            case 'GrayLimits'
                ...
                iptcheckinput(gl,{'logical','numeric'},{'vector','real'},...
                    mfilename, 'GL', idx); % iptcheckinput %validateattributes
                if isempty(gl)
                    gl = [min(I(:)) max(I(:))];
                elseif numel(gl) ~= 2
